              ...
              children: [
                ...
                Padding(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: DataTable(border: TableBorder.all(color: Colors.blueGrey), sortColumnIndex: 0, sortAscending: true, columns: [
                      ...
                      DataColumn(
                        label: Text("Teklif Durumu", style: tablobaslik),
                        numeric: true,
                      ),
                    ], rows: [
                      DataRow(cells: [
                        DataCell(
                          Text("Mahmut Kara", style: tablodatayazitipi),
                        ),
                        DataCell(
                          Text(
                            "Ledeksan",
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(
                                width: 10,
                                height: 9,
                                child: SvgPicture.asset("assets/icons/vector32.svg",
                                    colorFilter: const ColorFilter.mode(passiveButtonTextColor, BlendMode.srcIn), width: 9, height: 14),
                              ),
                            ],
                          ),
                        ),
